        ...
        <div className="shopByCategories__card">
          <div className="shopByCategories__cards">
            <div style={{ display: "inline-block", overflow: "hidden" }}>
              <img
                ...
                src="https://st.depositphotos.com/1096434/2608/v/600/depositphotos_26087351-stock-illustration-car-wheel.jpg"
                alt="image"
              />
            </div>
            <div>
              ...
              <button className="shopByCategories__cards-button">
                Посмотреть больше
              </button>
            </div>
          </div>
          <div className="shopByCategories__cards">
            <div style={{ display: "inline-block", overflow: "hidden" }}>
              <img
                className="shopByCategories__cards-img"
                src="https://itc.ua/wp-content/uploads/2015/02/carvi.jpg"
                alt="image"
              />
            </div>
            <div>
              ...
              <ul className="shopByCategories__cards-ul">
                ...
                <li className="shopByCategories__cards-li">Видеорегистратор</li>
                <li className="shopByCategories__cards-li">Экран ТВ</li>
                <li className="shopByCategories__cards-li">Умные часы</li>
                <li className="shopByCategories__cards-li">USB-подключение</li>
              </ul>
              <button className="shopByCategories__cards-button">
                Посмотреть больше
              </button>
          ...
          <div className="shopByCategories__cards">
            ...
            <div>
              <h3 className="shopByCategories__cards-h3">МАСЛЯНЫЕ ЖИДКОСТИ</h3>
              <ul className="shopByCategories__cards-ul">
                ...
                <li className="shopByCategories__cards-li">Пустынный моллит</li>
          ...
          <div className="shopByCategories__cards">
            ...
            <div>
              ...
              <ul className="shopByCategories__cards-ul">
                ...
                <li className="shopByCategories__cards-li">Внутренний свет</li>
          ...
          <div className="shopByCategories__cards">
            ...
            <div>
              ...
              <ul className="shopByCategories__cards-ul">
                ...
                <li className="shopByCategories__cards-li">Тормозные детали</li>
                <li className="shopByCategories__cards-li">Шок и подвеска</li>
                <li className="shopByCategories__cards-li">Верхняя одежда</li>
                <li className="shopByCategories__cards-li">Выхлоп и выбросы</li>
              </ul>
              <button className="shopByCategories__cards-button">
                Посмотреть больше
              </button>
